...
program na deterministički način. Menadžer paketa uvodi \verb|Cargo.lock| i \verb|Cargo.toml|
fajlove. \verb|Cargo.toml| održava spisak paketa koji se trenutno koriste u programu. \verb|Cargo.lock| omogućava da se 
pri rekonstrukciji programa identični paketi koriste praćenjem heš vrednosti paketa i njihovih semantičkih verzija.
...
\verb|Cargo| se koristi da bi se jednostavno inicijalizovao novi \verb|Crate|. 
dodavanje/brisanje paketa 
konstruisanje i izvrsavanje
