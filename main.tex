...
Deo formiranja apstraktnog sintaksnog stabla jeste rezolucija imena.
...
U izvornom kodu \ref{lst:resolution} kako znamo da li je u liniji 3 "a" tip ili vrednost 1?
Ovakvi konflikti se rešavaju prilikom rezolucije imena. U ovom slučaju imena tipova i promenljivih se nalaze 
...
\begin{enumerate}
    ...
    \item for petlje su konvertovane u while(let) petlje.
