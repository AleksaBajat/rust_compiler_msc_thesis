...
u novi token putem simbola. Apstraktno sintaksno stablo se često koristi i zbog tog razloga 
...
Svaki tip otvorenog delimitera mora biti zatvoren delimiterom istog tipa koji je zatvoren.
\begin{verbatim}
fn lex_token_trees(
    &mut self,
    is_delimited: bool,
...
tok tokena izmedju novog para zagrada.
\begin{verbatim}
...
Utvrdjeno je da po uspešnom završetku obrade poziva funkcije \verb|lex_token_trees| 
trenutni token je pozicioniran na zatvoreni tip delimiter-a. To omogućava validaciju 
